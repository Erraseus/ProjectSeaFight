...
[CreateAssetMenu(menuName = "Item/Craftable/Ship", fileName = "new Ship")]
public class Ship : ScriptableObject, IItem, ICraftableItem
{
    #region Properties
    //Item
    public int Id => _id;
    ...
    //Slots
    public int CannonSlots => _cannonSlots;
    public int SailSlots => _sailSlots;
    public int CrewmateSlots => _crewmateSlots;
    #endregion
